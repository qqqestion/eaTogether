...
abstract class BaseFragmentV2<VM : BaseViewModel>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.navigationCommands.observe(viewLifecycleOwner) { navCommand ->
            Log.d("!!!", "Navigate to $navCommand")
            when (navCommand) {
                is NavigationCommand.To -> findNavController().navigate(navCommand.direction)
            }
        }
    }
